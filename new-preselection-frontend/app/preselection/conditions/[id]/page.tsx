        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-3xl font-bold tracking-tight text-foreground">Conditions de présélection</h1>
          ...
          <Alert className="mb-6">
            ...
            <AlertDescription>
              Les critères sont appliqués dans l'ordre de priorité : Mention au bac → Série au bac → Notes par matière.
              Configurez chaque critère selon vos besoins.
            </AlertDescription>
          </Alert>
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Configuration de la capacité et du taux de liste d'attente</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <label className="text-sm font-medium text-foreground">Capacité maximale</label>
                  <input
                    type="number"
                    defaultValue={conditions?.capaciteMax || parcoursData.capacite}
                  ...
                  />
                  <p className="mt-1 text-xs text-muted-foreground">Nombre maximum d'étudiants à sélectionner</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-foreground">Taux liste d'attente (%)</label>
                  <input
                    type="number"
