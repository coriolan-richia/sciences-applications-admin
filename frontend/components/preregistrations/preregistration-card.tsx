...
export function PreregistrationCard({ preregistration }: PreregistrationCardProps) {
  const statusColors = {
        ...
        <div className="flex items-start justify-between">
          <div className="space-y-3 flex-1">
            <div className="flex items-center gap-2">
              <h3 className="font-semibold text-foreground">{preregistration.bacNumber}</h3>
              <Badge className={statusColors[preregistration.status]}>{preregistration.status}</Badge>
            </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span>{new Date(preregistration.preregistrationDate).toLocaleDateString()}</span>
              </div>
            </div>
          </div>
        </div>
