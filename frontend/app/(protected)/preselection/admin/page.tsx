  ...
  return (
    <div className="flex h-full flex-col">
      <PageHeader
        ...
        description="Vue d'ensemble des conditions de présélection par parcours"
        action={
      ...
      <div className="flex-1 overflow-y-auto items-center flex flex-col">
        <div className="space-y-6 w-full max-w-7xl p-8 ">
          {/* Alert de danger */}
