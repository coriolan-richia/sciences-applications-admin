...
export default function PaymentsPage() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <Tabs defaultValue="payments" className="flex flex-col h-0 flex-1">
        <TabsList className="m-8 mb-6 w-md">
          <TabsTrigger value="payments">Relevés de Paiement</TabsTrigger>
          <TabsTrigger value="uploads">Historique d'Importation</TabsTrigger>
        </TabsList>

        <div className="p-8 pt-0 flex flex-1 flex-col items-center overflow-y-auto">
          <TabsContent
            value="payments"
          ...
          >
            ...
            <div className="rounded-lg border border-border bg-card">
              ...
              {isPaymentLoading ? (
                ...
                <div className="flex items-center gap-4 border-b border-border px-6 py-4">
                  <div className="flex-1 text-center text-sm text-muted-foreground">
                    Aucune donnée de paiement à lister
                  </div>
                </div>
              ) : (
          ...
          {/* p-8 pt-0 space-y-6 overflow-y-auto flex-1 flex flex-col */}
          <TabsContent value="uploads" className="space-y-6 w-full">
